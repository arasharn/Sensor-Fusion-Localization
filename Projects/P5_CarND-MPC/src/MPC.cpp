...
// size_t N = 25; //Quiz
// double dt = 0.05; //Quiz
// size_t N = 20; can't make the 2nd term
// size_t N = 30; // longer horizon didn't help
// size_t N = 15; // Acts poorly in turns
// size_t N = 10; // Getting there but yet large
size_t N = 8;
// size_t N = 5; // Blows up!!

 // 0.05 makes a sinosoidal/zig-zak motion
double dt = 0.1;
